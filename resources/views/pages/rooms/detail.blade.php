                        ...
                        <div class="blog_details">
                            ...
                            <div class="room-features mb-4">
                                <div class="row mb-1">
                                    ...
                                    <div class="col-6 text-right text-grey">Sleeps {{ $room->max_occupancy }}</div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6 text-right text-grey">{{ $room->bed_configuration }}</div>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6 text-right text-grey">{{ $room->room_size }} m <sup class="text-grey">2</sup></div>
                                </div>
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-6 text-right text-grey">{{ $room->bathrooms }}</div>
                                </div>

                                @if (!empty($room->room_view))
                                    <div class="row mb-1">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6 text-right text-grey">{{ $room->room_view }}</div>
                                    </div>
                                @endif
                                ...
                                <div class="row mb-1">
                                    ...
                                    @if ($room->smoking_policy == true)
                                        <div class="col-6 text-right text-grey">Smoking</div>
                                    @else
