...
@section('main')
    ...
    <main>
        ...
        <div class="slider-area">
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center" data-background="{{ asset('assets/img/hero/servicespage_hero.jpg') }}" >
                <div class="container">
                    <div class="row ">
